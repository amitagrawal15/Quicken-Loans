...
# Create a random decision tree to be used as an example in the deck

plt.figure(figsize=(20,20))
_ = tree.plot_tree(clf.estimators_[99], feature_names=x_training_data.columns, filled=True)